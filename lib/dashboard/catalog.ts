...
export const dashboardCatalog = defineCatalog(schema, {
  components: {
    ...
    CustomerRanking: { props: z.object({ ...base, data: z.array(z.object({ rank: z.number(), id: z.string(), name: z.string(), segment: z.string(), value: z.number() })) }), description: "A precise customer billing ranking with the requested count, names, values, and relative amounts." },
