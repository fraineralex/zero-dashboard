...
const columns: Record<ErpCollection, Column[]> = {
  ...
  posTickets: [{ key: "id", label: "Ticket" }, { key: "date", label: "Fecha" }, { key: "cashier", label: "Cajera" }, { key: "register", label: "Caja" }, { key: "paymentMethod", label: "Pago" }, { key: "amount", label: "Cobrado", format: "dop" }],
